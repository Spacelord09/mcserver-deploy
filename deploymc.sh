...
add-git-ignore(){
    ...
    grep ".selected_editor" $home_dir/.gitignore || printf ".selected_editor\n" >> $home_dir/.gitignore
    grep ".config/" $home_dir/.gitignore || printf ".config/\n" >> $home_dir/.gitignore
    grep "mcdeploy.log" $home_dir/.gitignore || printf "mcdeploy.log\n" >> $home_dir/.gitignore
    
    if (whiptail --backtitle "mcdeploy by. Spacelord <admin@spacelord09.de>" --title "Minecraft .gitignore" --yesno "Do you want to install a minecraft specific '.gitignore'?" 8 78); then
        ...
        if (whiptail --backtitle "mcdeploy by. Spacelord <admin@spacelord09.de>" --title "Edit .gitignore?" --yesno "Do you want to edit the '.gitignore' yourself?" 8 78); then
